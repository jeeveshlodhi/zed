...
use android_emulator::AndroidEmulatorPanel;
...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        let android_emulator_panel =
            AndroidEmulatorPanel::load(workspace_handle.clone(), cx.clone());
        ...
        futures::join!(
            ...
            add_panel_when_ready(android_emulator_panel, workspace_handle.clone(), cx.clone()),
